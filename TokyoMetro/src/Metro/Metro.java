...
public class Metro {
    ...
    public void createStations() {
        ...
        // YELLOW LINE
        line.clear();
        line.add(Color.YELLOW);
        shinjuku.addLine(Color.YELLOW);
        yoyogi.addLine(Color.YELLOW);
        ...
        akihabara.addLine(Color.YELLOW);

        // RED LINE
        line.clear();
        line.add(Color.RED);
        tokyo.addLine(Color.RED);
        ochanomizu = new Station("Ochanomizu", 35.6993854, 139.7652479, line, 388, 173);
        yoyogi.addLine(Color.RED);
        shinjuku.addLine(Color.RED);
    ...
    public void createGraph() {
        ...
        final double penalty = 35 * 0.083;
        //WE CREATE A NODE FOR EACH STATION
        metro.setNodes(new ArrayList());
        for (Station s : this.stations) {
