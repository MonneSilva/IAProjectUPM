...
public class LiteInterface extends javax.swing.JFrame {
    ...
    public String stationF,stationT,tiempo,metros;
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new DefaultComboBoxModel<String>(Tokyo.getStationsN().toArray(new String[0])));
        ...
        jComboBox2.setModel(new DefaultComboBoxModel<String>(Tokyo.getStationsN().toArray(new String[0])));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        updateSL();
        this.jTextField1.setText( minuts + " min," + secs+" sec");
        DecimalFormat df = new DecimalFormat("#.000");;
        this.jTextField2.setText(df.format(distan) + " km");
